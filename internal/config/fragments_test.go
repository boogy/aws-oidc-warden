...
// config_fragments: parsing and the allow-list of keys a fragment may set,
// merge semantics against the base config, and the integrity audit — a
// fragment must never widen the base's authorization surface, survive a
// reload mutated, or outrank a base role_mapping.
